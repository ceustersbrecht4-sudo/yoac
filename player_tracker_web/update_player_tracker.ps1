...
$files = @("app.py", "teams.py", "accounts.py", "security.py", "content_check.py", "quota.py", "compact.py", "tracker.py", "README.md", "templates/_usage.html", "legal.py", "SECURITY.md", "requirements.txt", "templates/account.html", "templates/legal.html", "templates/login.html", "templates/index.html", "templates/landing.html", "templates/_cookie_banner.html",
